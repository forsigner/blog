...
- [prerender-node](https://github.com/prerender/prerender-node) - SEO优化工具
...
- [q](https://github.com/kriskowal/q) - 基于Promise的解决回调问题方案
- [bluebird](https://github.com/petkaantonov/bluebird) - 基于Promise的解决回调问题方案
- [sequelize](https://github.com/sequelize/sequelize) - ORM for Node.js & io.js
- [phpjs](https://github.com/kvz/phpjs) - JS实现的php函数
- [underscore](https://github.com/jashkenas/underscore) - JS工具库
- [underscore.string](https://github.com/epeli/underscore.string) - 字符串工具
- [lodash](https://github.com/lodash/lodash) - JS工具库
- [passport](https://github.com/jaredhanson/passport) - nodejs认证工具
- [PM2](https://github.com/Unitech/PM2) - 生产环境使用的 nodejs进程管理工具
- [nodemon](https://github.com/remy/nodemon) - 开发环境使用的 nodejs进程管理工具
- [lib-qqwry](https://github.com/cnwhy/lib-qqwry) - ip解析工具
- [cheerio](https://github.com/cheeriojs/cheerio) - 服务器端的JQ，抓取网页用的
- [node-formidable](https://github.com/felixge/node-formidable) - nodejs文件上传
- [iconv-lite](https://github.com/ashtuchkin/iconv-lite) - 处理node编码问题
- [bufferhelper](https://github.com/JacksonTian/bufferhelper) - 处理buffer
- [gbk](https://github.com/turingou/gbk) - 处理node编码问题
- [ccap](https://github.com/DoubleSpout/ccap) - 生成验证码
- [commander.js](https://github.com/tj/commander.js) - node.js command-line interfaces made easy
- [nodejieba](https://github.com/yanyiwu/nodejieba) - nodejs分词
- [node-segment](https://github.com/leizongmin/node-segment) - nodejs分词
- [node-cron](https://github.com/ncb000gt/node-cron) - 时间任务工具
- [later](https://github.com/bunkat/later) - 时间任务工具

- [express](https://github.com/strongloop/express) - 最流行的nodejs框架
- [sails](https://github.com/balderdashy/sails) - nodejs框架
- [meteor](https://github.com/meteor/meteor) - nodejs框架
- [mean](https://github.com/linnovate/mean)  - 全栈JS框架
- [connect](https://github.com/senchalabs/connect) - 强大的nodejs中间件
- [mean](https://github.com/meanjs/mean) - Full-Stack JavaScript
- [oauth2orize](https://github.com/jaredhanson/oauth2orize) - nodejs oauth2 服务
- [request](https://github.com/request/request) - Simplified HTTP request client.
- [cluster](https://github.com/LearnBoost/cluster) - nodejs多核
- [Ghost](https://github.com/TryGhost/Ghost) - 新一代blog



## express
- [node-oauth2-server](https://github.com/thomseddon/node-oauth2-server) - express oauth 服务

## koa
- [koa](https://github.com/koajs/koa) - 下一代nodejs框架
- [examples](https://github.com/koajs/examples) -示例
- [koa-oauth-server](https://github.com/thomseddon/koa-oauth-server) - oauth2服务
- [koa-router](https://github.com/alexmingoia/koa-router) - 路由
- [koa-router](https://github.com/alexmingoia/koa-router) - 路由
- [co-views](https://github.com/tj/co-views) - koa视图
- [koa-validate](https://github.com/RocksonZeta/koa-validate) - 参数验证
- [koa-body](https://github.com/dlau/koa-body) - 一个body parser中间件
- [bodyparser](https://github.com/koajs/bodyparser) - 一个body parser中间件
- [koa-prerender](https://github.com/RisingStack/koa-prerender) - SEO优化用的
- [koa-middlewares](https://github.com/cnpm/koa-middlewares) - koa中间件集合
- [static](https://github.com/koajs/static) - 静态文件服务
- [static-cache](https://github.com/koajs/static-cache) - 静态文件服务
- [koa-passport](https://github.com/rkusa/koa-passport) - 基于Passport的验证
